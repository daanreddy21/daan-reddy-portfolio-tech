      ...
      <div className="container mx-auto px-4">
        ...
        <div className="py-12">
          <div className="text-center">
            ...
            <div className="mb-6 max-w-2xl mx-auto">
              ...
              <p className="text-gray-400 mt-2">Backend & Full Stack Developer (Data-Focused)</p>
              <p className="text-gray-400 mt-4 text-sm sm:text-base leading-relaxed">
                I build scalable web applications using Java, SQL, and modern full-stack technologies, with a focus on backend systems, data handling, and real-world problem solving.
              </p>
            </div>
            ...
            {/* Contact Info */}
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 mb-8 text-gray-400 text-sm">
              <a
                href="mailto:daanreddyalapaku2105@gmail.com"
                className="flex items-center gap-2 hover:text-neon-blue transition-colors duration-200"
              >
                <Mail className="w-4 h-4" />
                <span>daanreddyalapaku2105@gmail.com</span>
              </a>
        ...
        <div className="border-t border-dark-700 py-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2026 Daan Reddy A. All rights reserved.
          </p>
