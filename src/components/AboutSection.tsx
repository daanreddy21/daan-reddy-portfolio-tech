      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 sm:gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8 order-2 lg:order-2">
            ...
            {/* Education */}
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 gradient-text">Education</h3>
                  ...
                  <Card key={index} className="bg-dark-700/50 border-dark-600 hover:border-neon-blue/50 transition-all duration-300 group">
                    <CardContent className="p-3 sm:p-4">
                      <div className="flex items-start space-x-3 sm:space-x-4">
                        <div className="text-neon-blue group-hover:text-neon-green transition-colors duration-200 flex-shrink-0 mt-1">
                          {edu.icon}
                        </div>
                          ...
                          <div className="flex flex-col space-y-1 sm:space-y-2">
                            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 sm:gap-2">
                              <div className="min-w-0">
                                <h4 className="font-semibold text-white text-sm sm:text-base leading-tight">{edu.institution}</h4>
                                <p className="text-neon-blue text-xs sm:text-sm">{edu.degree}</p>
                              </div>
                              <div className="flex flex-col sm:text-right flex-shrink-0">
                                <p className="text-gray-400 text-xs">{edu.duration}</p>
                                <p className="text-neon-green font-medium text-xs sm:text-sm">{edu.grade}</p>
                              </div>
                            </div>
                          </div>
                        </div>
